...
class Client(Base):
    ...
    status = Column(String, default="Pendente", doc="Status do cliente (Ativo, Inadimplente, etc).")
    mrr = Column(Float, default=0.0, doc="Receita Recorrente Mensal gerada pelo cliente.")
    ltv = Column(Float, default=0.0, doc="Lifetime Value (Valor total gerado pelo cliente).")
